...
<div class="flex flex-col md:flex-row items-center bg-gray-100 py-8">
  <div class="w-full md:w-1/2 px-6">
    <img src="./src/img/home-desarrollo-web.webp" alt="Desarrollo Web" class="w-full h-auto">
  </div>
...
<div class="flex flex-col md:flex-row-reverse items-center py-8">
  <div class="w-full md:w-1/2 px-6">
    <img src="./src/img/home-desarrollo-movil.jpg" alt="Desarrollo de Aplicaciones Móviles" class="w-full h-auto">
  </div>
  <div class="w-full md:w-1/2 text-center md:text-left px-6">
...
<div class="flex flex-col md:flex-row items-center bg-gray-100 py-8">
  <div class="w-full md:w-1/2 px-6">
    <img src="./src/img/home-seguridad-software.webp" alt="Seguridad de Software" class="w-full h-auto">
  </div>
  <div class="w-full md:w-1/2 text-center md:text-left px-6">
