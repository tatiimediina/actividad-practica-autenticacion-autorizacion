...
export const renderBlogs = ($app) => {
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
      <img src="img/javascript.png" class="w-full h-48 object-cover" alt="JavaScript">
      <div class="p-4">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
      <img src="img/docker.png" class="w-full h-48 object-cover" alt="Docker">
      <div class="p-4">
    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
      <img src="img/agile.png" class="w-full h-48 object-cover" alt="Agile">
      <div class="p-4">
